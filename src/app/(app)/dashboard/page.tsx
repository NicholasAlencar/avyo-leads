...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<{ days?: string }> }) {
  ...
  return (
    <section className="mx-auto max-w-[1480px]">
      <p className="text-xs font-bold uppercase tracking-[0.18em] text-blue-600">Visão geral</p>
      <h1 className="mt-2 text-4xl font-semibold tracking-[-.045em] text-slate-950">Inteligência que move oportunidades.</h1>
