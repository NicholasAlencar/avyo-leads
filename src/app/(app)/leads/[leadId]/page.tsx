...
export default async function LeadDetailPage({ params }: { params: Promise<{ leadId: string }> }) {
  ...
  return (
    <section className="mx-auto max-w-[1500px]">
      ...
      <div className="mt-7 grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]"><div className="space-y-5"><LeadOverview lead={lead} workspace={workspace} /><LeadTimeline activities={workspace.activities} /></div><LeadRelations lead={lead} workspace={workspace} /></div>
    </section>
  );
}
